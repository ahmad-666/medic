...
eval("var articleWrapper = document.querySelector('#article');\nvar likeTrigger = articleWrapper.querySelector('#userLike');\nvar likeIcon = likeTrigger.querySelector('i');\nlikeTrigger.addEventListener('click', toggleLike);\n\nfunction toggleLike(e) {\n  likeIcon.classList.toggle('active');\n}\n\n//# sourceURL=webpack:///./src/article/scripts/article.js?");
